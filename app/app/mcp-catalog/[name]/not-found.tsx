import { ArrowLeft, Github, Home, Search } from 'lucide-react';
      ...
      <main className="flex-1 relative flex items-center justify-center">
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <Link href="/mcp-catalog" className="inline-flex items-center text-sm text-gray-600 hover:text-gray-900">
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600 mb-2">This MCP server doesn't exist in our catalog yet.</p>
              ...
              <ul className="space-y-3 text-left">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Use our search and filters to find what you need</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">If you know this server exists on GitHub, help us add it</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Explore our complete collection of MCP servers</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <a
                href={`${newIssueUrl}?title=Add%20missing%20MCP%20server&body=Please%20add%20this%20MCP%20server%20to%20the%20catalog:%0A%0AGitHub%20URL:%20`}
                target="_blank"
            ...
            <div className="mt-12 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <p className="text-sm text-amber-800">
                ...
                <br />
                Our automated system evaluates servers for trust scores. Check back soon or help us add this server.
              </p>
            </div>
          </div>
        </div>
