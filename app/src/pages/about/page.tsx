              ...
              <Card className="border-2 hover:border-yellow-200 transition-colors">
                <CardContent className="p-6 text-left">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed mb-4">
                    Experienced staff software engineer with 9+ years in full-stack development and expertise in Python,
                    TypeScript, Clojure, Go, SQL, and cloud infrastructure, who transitioned from a career as a
                    biochemist at Harvard & McGill.
                  </p>
