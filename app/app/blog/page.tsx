...
export const metadata: Metadata = {
  ...
  description: 'Latest news, updates, and insights from the Archestra team about MCP, AI agents, and enterprise platforms.',
};
        ...
        <div className="container relative z-10 px-4 md:px-6 py-16 max-w-7xl mx-auto">
          ...
          {posts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {posts.map((post) => (
                <article key={post.slug} className="bg-white rounded-lg border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow flex flex-col">
