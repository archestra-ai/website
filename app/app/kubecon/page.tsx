...
export default function KubeconPage() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-white flex flex-col items-center justify-start pt-20 p-8 pb-32 relative" style={{ fontFamily: "'Roboto Mono', monospace" }}>
        ...
        {isLoading ? (
          ...
          <div className="bg-black text-white text-2xl px-12 py-6 font-light">
            ⚠️ {error}
          </div>
        ) : (
          <>
            <div className="flex flex-col w-full">
              ...
              <h1 className="text-6xl text-black text-left px-8">
                 Convince sceptical AI
              </h1>
                ...
                <div className="divide-y divide-black border-2 border-black bg-white">
                  ...
                  {leaderboard.slice(0, 3).map((entry) => (
                    <div
                      ...
                      className={`flex items-center px-3 py-2 space-x-4 ${
                        entry.rank === 1 ? 'bg-gray-100' : ''
                      }`}
                    >
