          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
                Join us every Tuesday for our community calls where we discuss Archestra, share updates, and connect with fellow developers and AI enthusiasts.
              </p>
                  ...
                  <div className="flex items-start gap-4 mb-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-3 text-gray-700">
                        <p>
                          {formatMeetingDate(nextMeetingDate)}, {getLocalTime(nextMeetingDate)} ({localTimezoneName}), {MEETING_CONFIG.duration}
                        </p>
                      </div>
                    </div>
                  </div>
