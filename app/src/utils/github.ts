...
export function getMcpServerName({ github_info }: ArchestraMcpServerManifest): string {
  if (github_info.path) {
...
export function getMcpServerGitHubUrl({ github_info }: ArchestraMcpServerManifest): string {
