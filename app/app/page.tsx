...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Archestra | Enterprise MCP Platform for AI Agents",
    description:
      "Enterprise-grade platform for safely leveraging AI agents and MCP servers with security guardrails.",
  ...
  twitter: {
    ...
    description:
      "Enterprise-grade platform for safely leveraging AI agents and MCP servers",
  },
  alternates: {
  ...
  try {
    const [repoResponse, contributorsResponse, commitsResponse] =
      await Promise.all([
        ...
        fetch(
          "https://api.github.com/repos/archestra-ai/archestra/contributors",
          {
            next: { revalidate: 3600 },
          }
        ),
        fetch(
          "https://api.github.com/repos/archestra-ai/archestra/commits?per_page=1",
          {
            next: { revalidate: 3600 },
          }
        ),
        ...
        <div className="container relative z-10 px-4 md:px-6 py-16 max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto mb-8">
              At Archestra we're developing an enterprise-grade platform that
              enables non-technical users to safely leverage AI agents and MCP
            ...
            <div className="space-y-4 max-w-2xl mx-auto">
              <div className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Isolated execution environment for AI agents with sandboxing
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Securing the context to prevent leakage of data to the
                    context and changing agent's behaviour
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Compatible with thousands of existing MCP servers and
              ...
              <div className="flex items-start gap-4 p-4 bg-white rounded-lg border border-gray-200">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    We're building the desktop app and it's currently in early
                    alpha. Subscribe below to get notified when it's ready.
                  </p>
