  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = await fetch(
        "https://app.loops.so/api/newsletter-form/cmdehe4lw18tnwy0ifkz89qqk",
        {
          method: "POST",
          body: formBody,
          headers: {
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 relative overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #667eea 0%, #764ba2 25%, #f093fb 50%, #fda085 75%, #667eea 100%)",
            ...
            <div
              ...
              style={{
                ...
                animation: `floatPath${particle.id % 5} ${
                  particle.duration
                }s ease-in-out ${particle.delay}s infinite, rotateCube ${
                  particle.duration / 2
                }s linear infinite`,
              }}
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `0 0 ${particle.size}px rgba(255, 255, 255, ${
        ...
        <style jsx>{`
          ...
          @keyframes floatPath2 {
            ...
            20% {
              transform: translateY(-15vh) translateX(-8vw) scale(1.15)
                rotate(90deg);
            }
            40% {
              transform: translateY(30vh) translateX(12vw) scale(0.85)
                rotate(180deg);
            }
            60% {
              transform: translateY(-25vh) translateX(-15vw) scale(1.2)
                rotate(270deg);
            }
            80% {
              transform: translateY(15vh) translateX(10vw) scale(0.95)
                rotate(360deg);
            }
          }
        ...
        <div className="container relative z-10 px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 mb-8">
              A Comprehensive Empirical Analysis of the Model Context Protocol
              Ecosystem
            </p>

            <p className="text-lg text-gray-500 max-w-2xl mx-auto">
              An exhaustive examination of 900+ MCP server implementations,
              examining adoption trajectories, architectural patterns, and the
              evolution of AI agent instrumentation frameworks.
            </p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card className="border-2 hover:border-blue-200 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-semibold text-lg mb-2">
                        Quantitative Analysis: 900+ Implementations
                      </h3>
                      <p className="text-gray-600 text-sm">
                        Systematic evaluation of code quality metrics,
                        dependency graphs, and protocol adherence standards
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2 hover:border-green-200 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-semibold text-lg mb-2">
                        100k+ Inference Calls
                      </h3>
                      <p className="text-gray-600 text-sm">
                        LLM-powered feature extraction and source code analysis
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2 hover:border-purple-200 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-600 text-sm">
                        Vulnerability analysis, dependency risk quantification,
                        and third-party component evaluation methodologies
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2 hover:border-yellow-200 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <p className="text-gray-600 text-sm">
                        Statistical analysis of contributor diversity,
                        maintenance velocity, and ecosystem sustainability
                        indicators
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2 hover:border-red-200 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-semibold text-lg mb-2">
                        Protocol Specification Compliance Study
                      </h3>
                      <p className="text-gray-600 text-sm">
                        Empirical measurement of feature adoption rates and
                        implementation conformance to specification standards
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-2 hover:border-indigo-200 transition-colors">
                    <CardContent className="p-6">
                      ...
                      <h3 className="font-semibold text-lg mb-2">
                        Predictive Analysis: 2026 Protocol Trajectory
                      </h3>
                      <p className="text-gray-600 text-sm">
                        Examining MCP's potential for standardization:
                        enterprise adoption patterns and evolutionary pathways
                      </p>
                    </CardContent>
                  </Card>
                </div>
                  ...
                  <CardContent className="p-8 sm:p-12">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-gray-600">
                        Register for priority distribution of the State of MCP
                        Report upon publication. Receive evidence-based insights
                        to inform your AI infrastructure decisions.
                      </p>
                    </div>
                    ...
                    {!isSubmitted ? (
                      <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <p className="text-xs text-gray-500 text-center">
                          Privacy Policy: Your information will be used solely
                          for report distribution. Unsubscribe available.
                        </p>
                      </form>
                    ) : (
                      <div className="text-center py-8">
                        ...
                        <p className="text-gray-600">
                          You will receive notification upon publication of the
                          State of MCP Report.
                        </p>
                      </div>
                    )}
