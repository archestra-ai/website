    ...
    <>
      ...
      <div className="w-full py-8 text-center">
        ...
        <div className="newsletter-form-container" style={{ marginTop: 32, display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
          ...
          {status === "success" && (
            <div className="newsletter-success" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "100%" }}>
              <p className="newsletter-success-message" style={{ fontFamily: "Inter, sans-serif", color: "#000", fontSize: 14 }}>
                Thanks! We'll be in touch!
              </p>
            </div>
          )}
          {(status === "error" || status === "rate-limited") && (
            <div className="newsletter-error" style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "100%" }}>
              <p className="newsletter-error-message" style={{ fontFamily: "Inter, sans-serif", color: "#b91c1c", fontSize: 14 }}>
                {errorMessage}
              </p>
            </div>
          )}
