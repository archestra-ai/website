...
const SearchQuerySchema = z.object({
  ...
  limit: z.number().int().positive().max(100).default(20).optional().describe('Number of results to return'),
  offset: z.number().int().min(0).default(0).optional().describe('Number of results to skip'),
});
